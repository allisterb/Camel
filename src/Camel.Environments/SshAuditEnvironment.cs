...
public class SshAuditEnvironment : AuditEnvironment
{
    ...
    public DirectoryInfo GetDirectoryAsLocal(string remote_path, string local_path)
    {
       ...
       //Renci.SshNet.Common.
        ...
        if (r[0].IsMatch)
        {
            System.Text.RegularExpressions.Match m = r[0].Result as System.Text.RegularExpressions.Match;
        ...
        try
        {
            ...
            {
                ReaderFactory.OpenReader(fs).WriteAllToDirectory(this.WorkDirectory.FullName,
